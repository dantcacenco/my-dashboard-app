#!/bin/bash
echo "🔧 Fixing CustomerProposalView to use correct column names..."

# Update CustomerProposalView to use correct column names
...
# Commit and push
git add .
git commit -m "fix: update CustomerProposalView to use correct database column names

- Changed 'total' to 'total_price' for proposal items
- Added 'name' field to ProposalItem interface
- Display both name and description when available
- Fixed NaN display issues by using correct column names"
...
echo ""
echo "📝 Changes made:"
echo "- Updated total → total_price"
echo "- Added name field to proposal items"
echo "- Fixed all $NaN display issues"
echo ""
echo "Next: We still need to create the /api/proposal-approval endpoint for approvals to work"